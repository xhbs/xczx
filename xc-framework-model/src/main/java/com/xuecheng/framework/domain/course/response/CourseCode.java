...
public enum CourseCode implements ResultCode {
    ...
    COURSE_GET_NOTEXISTS(false, 31103, "课程基本信息不存在"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false, 31004, "创建课程索引信息失败"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false, 31005, "课程计划不存在"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false, 31006, "只能选择最底层课程");
    //操作代码
