...
public class HlsVideoUtil extends VideoUtil {
    ...
    String video_path = "D:\\BaiduNetdiskDownload\\com.xuecheng.auth.test1.avi";
    String m3u8_name = "com.xuecheng.auth.test1.m3u8";
    String m3u8folder_path = "D:/BaiduNetdiskDownload/Movies/com.xuecheng.auth.test1/";
...
//        commend.add("D:/BaiduNetdiskDownload/Movies/com.xuecheng.auth.test1/test1_%05d.ts");
        commend.add(m3u8folder_path + m3u8_name.substring(0, m3u8_name.lastIndexOf(".")) + "_%05d.ts");
//        commend.add("D:/BaiduNetdiskDownload/Movies/com.xuecheng.auth.test1/com.xuecheng.auth.test1.m3u8");
