...
public class AuthService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret) {
        ...
        boolean b = saveToken(access_token, content, tokenValiditySeconds);
        if (!b) {
    ...
    public AuthToken getUserToken(String token) {
        String user_token = "user_token:" + token;
        String userTokenString = stringRedisTemplate.opsForValue().get(user_token);
